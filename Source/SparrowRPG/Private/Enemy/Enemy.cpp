...
void AEnemy::CheckPatrolTarget()
{
	...
	{
		const int32 TimeSelection = FMath::RandRange(PatrolWaitMin, PatrolWaitMax);
		PatrolTarget = ChoosePatrolTarget();
		GetWorldTimerManager().SetTimer(PatrolTimer, this, &AEnemy::PatrolTimerFinished, TimeSelection);
	}
}
